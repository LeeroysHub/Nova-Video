...
import org.leeroy.mediaplayer.video.browser.BrowserByIndexedVideos.lists.ListDialog;
...
import org.leeroy.mediaplayer.video.info.MultipleVideoLoader;
import org.leeroy.mediaplayer.video.info.SortByFavoriteSources;
...
import org.leeroy.mediaplayer.video.leanback.presenter.TrailerPresenter;
import org.leeroy.mediaplayer.video.leanback.presenter.VideoBadgePresenter;
import org.leeroy.mediaplayer.video.leanback.presenter.WebLinkPresenter;
import org.leeroy.mediaplayer.video.leanback.scrapping.ManualVideoScrappingActivity;
...
import org.leeroy.mediaplayer.video.ui.LeeroyFlixProgressDialog;
...
import org.leeroy.mediaplayer.video.utils.StoreRatingDialogBuilder;
...
import org.leeroy.mediaprovider.video.VideoStoreImportImpl;
import org.leeroy.mediaprovider.video.VideoStoreInternal;
...
import org.leeroy.mediascraper.VideoTags;
...
public class VideoDetailsFragment extends DetailsFragmentWithLessTopOffset implements LoaderManager.LoaderCallbacks<Cursor>, PlayUtils.SubtitleDownloadListener, SubtitleInterface, Delete.DeleteListener, XmlDb.ResumeChangeListener, ExternalPlayerWithResultStarter {
    ...
    /** A serialized org.leeroy.mediaplayer.video.leanback.adapter.object.Video */
    ...
    private LeeroyFlixDetailsOverviewRowPresenter mOverviewRowPresenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOverviewRowPresenter = new LeeroyFlixDetailsOverviewRowPresenter(mDescriptionPresenter);
    ...
    final OnActionClickedListener mOnActionClickedListener = new OnActionClickedListener() {
        ...
        public void onActionClicked(Action action) {
            ...
            if (action.getId() == VideoActionAdapter.ACTION_REMOTE_RESUME) {
                ...
                TraktService.sync(LeeroyFlixUtils.getGlobalContext(), TraktService.FLAG_SYNC_AUTO);
            }
    ...
    public static class DialogRetrieveSubtitles extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
             ...
             */
            LeeroyFlixProgressDialog npd = new LeeroyFlixProgressDialog(getActivity());
    ...
    private void deleteScraperInfo(Video video) {
        ...
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID, "-1");
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE, "-1");
