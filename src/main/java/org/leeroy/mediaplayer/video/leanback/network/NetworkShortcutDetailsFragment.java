...
public class NetworkShortcutDetailsFragment extends DetailsSupportFragment implements OnActionClickedListener {
    ...
    private LeeroyFlixDetailsOverviewRowPresenter mDetailsRowPresenter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDetailsRowPresenter = new LeeroyFlixDetailsOverviewRowPresenter(new ShortcutDetailsPresenter());
