...
public class LeeroyFlixDetailsOverviewRowPresenter extends FullWidthDetailsOverviewRowPresenter {
     ...
     */
    public LeeroyFlixDetailsOverviewRowPresenter(Presenter detailsPresenter) {
        this(detailsPresenter, false);
    }

    public LeeroyFlixDetailsOverviewRowPresenter(Presenter detailsPresenter, boolean hideActions) {
