...
public class BrowserByVideoFolder extends BrowserByLocalFolder {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, LeeroyFlixActivity.MENU_CHANGE_FOLDER, Menu.NONE, R.string.menu_change_folder).setIcon(R.drawable.ic_menu_folder).setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case LeeroyFlixActivity.MENU_CHANGE_FOLDER:
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (newPath!=null) { //better safe than sorry
                    ...
                    if ((f!=null) && f.isDirectory() && f.exists()) { //better safe than sorry x3
                        ...
                        LeeroyFlixActivity bav = (LeeroyFlixActivity)getActivity();
