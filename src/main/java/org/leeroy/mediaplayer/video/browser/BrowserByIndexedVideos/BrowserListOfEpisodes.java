...
public class BrowserListOfEpisodes extends BrowserWithShowHeader {
    ...
    public void onViewCreated(View view, Bundle save ){
        ...
        ((ListView)mLeeroyFlixGridView).setDivider(new ColorDrawable(ContextCompat.getColor(getContext(), R.color.transparent_white_list_divider)));
        ((ListView)mLeeroyFlixGridView).setDividerHeight(3);
    }
    @Override
    public void onDestroyView() {
        ...
        ((MainActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.color.lightgrey));
