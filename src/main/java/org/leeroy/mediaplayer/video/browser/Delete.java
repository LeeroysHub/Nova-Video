...
public class Delete {
    ...
    private static List<Uri> getAssociatedFiles(Uri fileUri) {
        ...
        SingleVideoLoader videoLoader = new SingleVideoLoader(LeeroyFlixUtils.getGlobalContext(), fileUri.toString());
        ...
        if(cursor!=null&&cursor.getCount()>0){
            ...
            if(video!=null && video instanceof Episode){
                ...
                EpisodeTags tags = (EpisodeTags) video.getFullScraperTags(LeeroyFlixUtils.getGlobalContext());
                if (tags != null) {
                    EpisodesLoader episodesLoader = new EpisodesLoader(LeeroyFlixUtils.getGlobalContext(), tags.getShowId(), tags.getSeason(), false);
                    ...
                    if (shouldDeleteSeasonExportedFiles) {
                        ...
                        SeasonsLoader seasonLoader = new SeasonsLoader(LeeroyFlixUtils.getGlobalContext(), tags.getShowId());
