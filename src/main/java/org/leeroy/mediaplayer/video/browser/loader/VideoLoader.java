...
public abstract class VideoLoader extends CursorLoader implements CompatAndSDKCursorLoaderFactory {
    ...
    // for LeeroyFlixFragment line - enabled to prevent SQLite contention during scanning
    ...
    public static final int CHANNEL_THROTTLE_DELAY = 10; // 10s
    // for the non scraped video count in LeeroyFlixFragment
    ...
    public static String[] mProjection = {
            ...
            VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN,
            VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_LIBRARY,
            VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_STEREO,
            VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_DEFINITION,
            VideoStore.Video.VideoColumns.LEEROYFLIX_HIDDEN_BY_USER,
    ...
    public static String[] mDetailedProjection = concatTwoStringArrays(mProjection,new String[] {
            ...
            VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_BEST_AUDIOTRACK_FORMAT,
            VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_VIDEO_FORMAT,
            VideoStore.Video.VideoColumns.LEEROYFLIX_GUESSED_AUDIO_FORMAT,
            VideoStore.Video.VideoColumns.LEEROYFLIX_GUESSED_VIDEO_FORMAT,
            VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_BITRATE,
            VideoStore.Video.VideoColumns.LEEROYFLIX_FRAMES_PER_THOUSAND_SECONDS,
