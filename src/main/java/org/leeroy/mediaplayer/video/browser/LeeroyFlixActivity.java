 ...
 */
public class LeeroyFlixActivity extends BrowserActivity implements ExternalPlayerWithResultStarter {

    private static final Logger log = LoggerFactory.getLogger(LeeroyFlixActivity.class);
    ...
    private final static String StereoActivity = "org.leeroy.mediaplayer.video.browser.LeeroyFlixActivityStereo";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
        	Trakt.wipePreferences(PreferenceManager.getDefaultSharedPreferences(LeeroyFlixActivity.this),false);
        ...
        mTraktRelogBroadcastReceiver = new BroadcastReceiver(){
            ...
            public void onReceive(Context context, Intent intent) {
                if( System.currentTimeMillis() - Trakt.sLastTraktRefreshToken > Trakt.ASK_RELOG_FREQUENCY&&(mTraktRelogAlertDialog==null||!mTraktRelogAlertDialog.isShowing())) {
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(LeeroyFlixActivity.this);
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(intent.getAction())) {
            ...
            Cursor c = contentResolver.query(VideoStore.Video.Media.EXTERNAL_CONTENT_URI, CURSORS,
                    VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + "!=0" + (LoaderUtils.mustHideUserHiddenObjects() ? " AND " + LoaderUtils.HIDE_USER_HIDDEN_FILTER : ""), null,
                    VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + " DESC LIMIT 1");
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (((LeeroyFlixApp) getApplication()).isAutoScraperActive()) {
    ...
    private void resetScraperInfo() {
        ...
        cv.put(VideoStore.Video.Media.LEEROYFLIX_MEDIA_SCRAPER_ID, 0);
        cv.put(VideoStore.Video.Media.LEEROYFLIX_MEDIA_SCRAPER_TYPE, 0);
        ...
        protected Map doInBackground(Void... anything) {
            ...
            if (c != null && c.getCount() != 0) {
                ...
                int index_scraper_id = c
                        .getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID);
                c.moveToFirst();
                ...
                if (scraperId > 0) {
                    int scraperType = c
                            .getInt(c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE));
                    ...
                    if (scraperCursor.moveToFirst()) {
                        ...
                        if (scraperType == org.leeroy.mediascraper.BaseTags.MOVIE) {
