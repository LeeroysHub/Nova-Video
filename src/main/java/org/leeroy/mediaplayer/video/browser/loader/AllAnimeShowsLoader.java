...
public class AllAnimeShowsLoader extends VideoLoader {
    ...
    public String[] getProjection() {
        return new String[] {
                ...
                getTraktProjection(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN),
                getTraktProjection(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_LIBRARY),
    ...
    public String getSelection() {
        ...
        sb.append(" AND ");
        sb.append("( " + VideoStore.Video.VideoColumns.SCRAPER_S_GENRES + " LIKE '%" + mContext.getString(org.leeroy.medialib.R.string.tvshow_genre_animation) + "%')");
        sb.append(") GROUP BY (");
