...
public class NewVideosActionProvider extends ActionProvider implements
    ...
    private static final String SELECTION = VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID + " = 0 AND " +
    ...
    static class DropDownWindow extends PopupWindow implements OnAttachStateChangeListener {
        ...
        public void show() {
            ...
            // I tested that it works fine on LeeroyFlix@Android4.1 and XperiaPhone@Android4.0.3
