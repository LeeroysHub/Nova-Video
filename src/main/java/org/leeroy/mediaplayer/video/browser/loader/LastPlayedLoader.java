...
public class LastPlayedLoader extends VideoLoader {
    ...
    public LastPlayedLoader(Context context) {
        ...
        // only updates the CursorLoader on data change every 10s since used only in LeeroyFlixFragment as nonScraped box presence
        ...
        if (LoaderUtils.isSmartRecentlyRows()) {
            ...
            builder.appendQueryParameter("group", VideoStore.Video.VideoColumns.BOOKMARK+", COALESCE(" + VideoStore.Video.VideoColumns.SCRAPER_M_IMDB_ID + ", " + VideoStore.Video.VideoColumns.SCRAPER_S_IMDB_ID + ")");
    ...
    public String getSortOrder() {
        ...
        if (LoaderUtils.isSmartRecentlyRows()) {
            ...
            sortOrder = VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + " DESC LIMIT 50";
        }
