...
public abstract class BrowserMoviesBy extends CursorBrowserByVideo implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public void onResume() {
		((LeeroyFlixActivity)getActivity()).setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);
		super.onResume();
    ...
    public void onItemClick(AdapterView parent, View view, int position, long id) {
		...
		((LeeroyFlixActivity)getActivity()).setNavigationMode(ActionBar.NAVIGATION_MODE_STANDARD);
    }
