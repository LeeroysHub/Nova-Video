...
abstract public class BrowserCategory extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(getActivity() instanceof BrowserActivity)
            ((LeeroyFlixActivity)getActivity()).updateHomeIcon(getParentFragmentManager().getBackStackEntryCount()>1);
    ...
    private void updateCategoryContent(Fragment fragment, String tag) {
        ...
        if (fm != null) {
            ...
            if(getActivity() instanceof BrowserActivity)
                ((LeeroyFlixActivity)getActivity()).updateHomeIcon(getParentFragmentManager().getBackStackEntryCount()>0);
        }
    }
