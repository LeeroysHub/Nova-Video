...
public class StereoMergeLeeroyFlixEffect extends VideoEffect
{
    ...
    private static final String SET_S3D_MODE_INTENT = "leeroy.intent.s3d.mode";
    
    private Context mContext;
    private SharedPreferences mPreferences;
    
    private final static String TAG="StereoMergeLeeroyFlixEffect";

    public StereoMergeLeeroyFlixEffect(Context context) {
        mContext = context;
    ...
    public int getEffectType() {
        return VideoEffect.EFFECT_STEREO_MERGE_LEEROYFLIX;
    }
