...
import static org.leeroy.mediaplayer.utils.ISO639codes.isLanguageInString;
...
import static org.leeroy.mediaplayer.video.utils.VideoPreferencesCommon.KEY_AUDIO_SPEED_AUDIOTRACK;
import static org.leeroy.mediascraper.StringUtils.stringContainsForced;
...
public class PlayerService extends Service implements Player.Listener, IndexHelper.Listener {
	...
	AdditionalServiceSingleton.getInstance().bindToService(getApplicationContext());
        ...
        //We can go down to 10% PLayback speed on AudioTrack
        ...
        public void onChange(boolean selfChange) {
            if (mVideoInfo != null && (mVideoInfo.id==-1||mVideoInfo.scraperId <=0)&&!PrivateMode.isActive()){ // if we need to update
                ...
                if (info != null) {
                    ...
                    if (LeeroyFlixFeatures.isAndroidTV(PlayerService.this) && !PrivateMode.isActive())
    ...
    protected float mAudioSpeedMin = 0.5f;
