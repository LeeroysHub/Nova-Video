    ...
    private void attachWindow() {
        ...
        if (mSubtitleLayout != null) {
            ...
            mRootView.setOnSystemUiVisibilityChangeListener(visibility -> {
                ...
                //if (log.isDebugEnigationBarShowing, mSystemBarShowing, mActionBarShowing, PlayerControlleabled()) log.debug("attachWindow, setOnSystemUiVisibilityChangeListener: mNavigationBarShowing={}, mSystemBarShowing={}, mActionBarShowing={}, mControlBarShowing={}, mIsNavBarOnBottom={}, mIsGestureAreaShowing={}",
                        //mNavr.isControlBarShowing(), mIsNavBarOnBottom, mIsGestureAreaShowing);
