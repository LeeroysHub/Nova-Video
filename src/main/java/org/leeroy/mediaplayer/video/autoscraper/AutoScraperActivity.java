...
import org.leeroy.mediascraper.NfoWriter;
...
public class AutoScraperActivity extends AppCompatActivity implements AbsListView.OnScrollListener,
    ...
    public void onCreate(Bundle icicle) {
        ...
        LeeroyFlixApp app = (LeeroyFlixApp)getApplication();
...
*/
    ...
    private void startBrowserActivity() {
        Intent intent = new Intent(this, LeeroyFlixActivity.class);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_DPAD_CENTER || keyCode == KeyEvent.KEYCODE_ENTER) && event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            if (focusedItem != null) {
                // The user is using the LeeroyFlix remote to control this activity and he pressed the OK key
    ...
    private static final String WHERE_FOLDER_MODE = VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID +
            "=? AND " + VideoStore.Video.VideoColumns.LEEROYFLIX_HIDE_FILE + "=0 AND " + MediaColumns.DATA + " LIKE ?";
    private static final String WHERE_ALL_MODE = VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID +
            "=? AND " + VideoStore.Video.VideoColumns.LEEROYFLIX_HIDE_FILE + "=0 AND " + MediaColumns.DATA + " NOT LIKE ?";
    ...
    private void getColumnIndices(Cursor cursor) {
        if (cursor != null) {
            ...
            mScraperTypeIndex = cursor.getColumnIndexOrThrow(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE);
    ...
    protected void updateScraperInfoInMediaLib(String path, int scraperId, int typeId) {
        ...
        cv.put(VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID, String.valueOf(scraperId));
        cv.put(VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE, String.valueOf(typeId));
    ...
    protected void trySearchingAgain() {
        ...
        // Force the focus on the list so that it can be controlled with the LeeroyFlix remote if needed
