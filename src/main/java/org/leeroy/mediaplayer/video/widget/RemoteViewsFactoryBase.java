...
abstract class RemoteViewsFactoryBase implements RemoteViewsService.RemoteViewsFactory {
    ...
    protected final String WHERE_NOT_HIDDEN = VideoColumns.LEEROYFLIX_HIDE_FILE + "=0";
    ...
    *****************************************************************/
    ...
    public RemoteViews getViewAt(int position) {
		...
		final int scraperId = mCursor.getInt(mCursor.getColumnIndexOrThrow(VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID));
		final int scraperType = mCursor.getInt(mCursor.getColumnIndexOrThrow(VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE));
        ...
        if (scraperType == org.leeroy.mediascraper.BaseTags.TV_SHOW) {
            int season,episode;
            try {
                showId = mCursor.getLong(mCursor.getColumnIndexOrThrow(VideoColumns.SCRAPER_SHOW_ID));
