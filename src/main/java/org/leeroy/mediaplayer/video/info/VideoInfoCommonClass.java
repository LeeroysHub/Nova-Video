...
public class VideoInfoCommonClass {
    ...
    public static String getVideoTrackString(VideoMetadata videoMetadata, Resources resources ){
        ...
        switch (video.s3dMode) {
            case VideoStore.Video.VideoColumns.LEEROYFLIX_STEREO_3D_TB:       sb.append("3D-TB"); break;
            case VideoStore.Video.VideoColumns.LEEROYFLIX_STEREO_3D_SBS:      sb.append("3D-SBS"); break;
            case VideoStore.Video.VideoColumns.LEEROYFLIX_STEREO_3D_ANAGLYPH: sb.append("3D-Anaglyph"); break;
            case VideoStore.Video.VideoColumns.LEEROYFLIX_STEREO_3D_UNKNOWN:  sb.append("3D"); break;
            default: break;
        }
