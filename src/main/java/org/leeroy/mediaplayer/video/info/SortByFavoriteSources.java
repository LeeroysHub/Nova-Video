    ...
    @Override
        ...
        if(found1&&found2){
            ...
            if(video1.getNormalizedDefinition()!=video2.getNormalizedDefinition()){ // return better resolution
                ...
                if(video1.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_4K)
                    return -1;
                if(video2.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_4K)
                    return 1;
                if(video1.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_1080P)
                    return -1;
                if(video2.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_1080P)
                    return 1;
                if(video1.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_720P)
                    return -1;
                if(video2.getNormalizedDefinition() == VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_720P)
                    return 1;
