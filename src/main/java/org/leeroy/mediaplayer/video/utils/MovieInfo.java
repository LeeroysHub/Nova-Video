...
public class MovieInfo extends BaseInfo {
    ...
    public MovieInfo(ContentResolver cr, long movieID) {
        ...
        try {
            String selection = VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_ID + "=? AND "
                    + VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE + "=" + ScraperStore.SCRAPER_TYPE_MOVIE;
