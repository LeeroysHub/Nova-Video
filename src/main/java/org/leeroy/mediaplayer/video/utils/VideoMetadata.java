...
public class VideoMetadata implements Serializable {
    ...
    public ContentValues toContentValues(){
        ...
        if(mVideoTrack!=null) {
            cv.put(VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_BITRATE, mVideoTrack.bitRate);
            cv.put(VideoStore.Video.VideoColumns.LEEROYFLIX_FRAMES_PER_THOUSAND_SECONDS, String.valueOf(mVideoTrack.fpsRate * 100));
            cv.put(VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_VIDEO_FORMAT, mVideoTrack.format);
        }
        ...
        for (int n=0; n<getAudioTrackNb(); n++) {
                ...
                cv.put(VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_BEST_AUDIOTRACK_FORMAT,getAudioTrack(n).format);
        ...
        json+="]}";
        cv.put(VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_BEST_AUDIOTRACK_FORMAT,json);
