...
public class DbUtils {
    ...
    static public void markAsRead(final Context context, final Video video) {
        ...
        if (!traktSync) {
            values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN, Trakt.TRAKT_DB_MARKED);
        }
    ...
    static public  void markAsNotRead(final Context context, final Video video) {
        ...
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN, Trakt.TRAKT_DB_UNMARK);
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED, 0);
    ...
    public static void markHiddenValue(Context context, Long[] videoIds, int value) {
        ...
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_HIDDEN_BY_USER, value);
        String whereString ="";
    ...
    public static void markAsHiddenByUser(final Context context, final Season season) {
        ...
        final ContentValues values = new ContentValues();
        values.put(VideoStore.Video.VideoColumns.LEEROYFLIX_HIDDEN_BY_USER, 1);
