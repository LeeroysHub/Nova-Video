...
public class VideoUtils {
    ...
    // keep in sync with org.leeroy.mediaprovider.LeeroyFlixMediaFile
  ...
  */
    ...
    // provide path for file like content://org.leeroy.media/external/video/media/51
    ...
    public static long getLastTimeVideoPlayedUtcFromVideoStore(Context context) {
        ...
        Cursor cursor = null;
        try {
            String[] projection = {VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED};
            String selection = VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + " > 0";
            String sortOrder = VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + " DESC LIMIT 1";
            ...
            if (cursor != null && cursor.moveToFirst()) {
                lastPlayedUtc = cursor.getLong(cursor.getColumnIndexOrThrow(VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED));
            }
        } finally {
            if (cursor != null) {
                cursor.close();
