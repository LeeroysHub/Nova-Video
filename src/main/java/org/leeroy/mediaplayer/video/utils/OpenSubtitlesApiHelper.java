...
public class OpenSubtitlesApiHelper {
    ...
    private static String resetTimeUTC = "2100-04-21T00:00:00Z"; // long live LeeroyFlix (I should be dead by then) (Um, Morbid but I love these finds! I hereby pledge to upload my brain to the cloud if possible, so Ill be here!)
