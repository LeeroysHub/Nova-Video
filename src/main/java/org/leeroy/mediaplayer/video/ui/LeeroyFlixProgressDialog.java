 ...
 *
 * <code>LeeroyFlixProgressDialog</code> is a modal dialog, which prevents the
 ...
 */
public class LeeroyFlixProgressDialog extends AlertDialog {

    private final static boolean DBG = false;
    private static final String TAG = LeeroyFlixProgressDialog.class.getSimpleName();
    
    /**
     * Creates a LeeroyFlixProgressDialog with a circular, spinning progress
     * bar. This is the default.
     */
    public static final int STYLE_SPINNER = 0;
    
    /**
     * Creates a LeeroyFlixProgressDialog with a horizontal progress bar.
     */
     ...
     */
    public LeeroyFlixProgressDialog(Context context) {
        super(context);
        mContext = context;
        initFormats();
    }
     ...
     */
    public LeeroyFlixProgressDialog(Context context, int theme) {
        super(context, theme);
        mContext = context;
        initFormats();
    }
    ...
    /**
     * Creates and shows a LeeroyFlixProgressDialog.
     *
     * @param context the parent context
     * @param title the title text for the dialog's window
     * @param message the text to be displayed in the dialog
     * @return the LeeroyFlixProgressDialog
     */
    public static LeeroyFlixProgressDialog show(Context context, CharSequence title,
    ...
    public static LeeroyFlixProgressDialog show(Context context, CharSequence title,
        ...
        LeeroyFlixProgressDialog dialog = new LeeroyFlixProgressDialog(context);
    ...
    /**
     * Change the indeterminate mode for this LeeroyFlixProgressDialog. In indeterminate
     * mode, the progress is ignored and the dialog shows an infinite
     * animation instead.
     *
     * <p><strong>Note:</strong> A LeeroyFlixProgressDialog with style {@link #STYLE_SPINNER}
    ...
    /**
     * Whether this LeeroyFlixProgressDialog is in indeterminate mode.
     *
    ...
    /**
     * Sets the style of this LeeroyFlixProgressDialog, either {@link #STYLE_SPINNER} or
     ...
     *
     * @param style the style of this LeeroyFlixProgressDialog, either {@link #STYLE_SPINNER} or
