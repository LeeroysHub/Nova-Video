...
public class LocalListingFragment extends ListingFragment {
    ...
    protected void createBlacklisted() {
        ...
        if (result) {
            ...
            LeeroyFlixUtils.addBreadcrumb(SentryLevel.INFO, "LocalListingFragment.createBlacklisted", "scan request VideoStoreImportService intent action ACTION_VIDEO_SCANNER_METADATA_UPDATE");
            serviceIntent.setAction(LeeroyFlixMediaIntent.ACTION_VIDEO_SCANNER_METADATA_UPDATE);
    ...
    private void deleteBlacklisted() {
        ...
        if (result) {
            ...
            LeeroyFlixUtils.addBreadcrumb(SentryLevel.INFO, "LocalListingFragment.deleteBlacklisted", "remove video from this directoty VideoStoreImportService intent action ACTION_VIDEO_SCANNER_METADATA_UPDATE");
