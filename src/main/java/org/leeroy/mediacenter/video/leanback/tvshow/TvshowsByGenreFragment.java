...
import org.leeroy.mediacenter.video.browser.loader.TvshowsByGenreLoader;
import org.leeroy.mediacenter.video.browser.loader.TvshowsNoAnimeByGenreLoader;
...
public class TvshowsByGenreFragment extends TvshowsByFragment {
    ...
    static {
        ...
        sortOrderIndexer.put(2, new TvshowsSortOrderEntry(R.string.sort_by_date_played_desc, "max(" + VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED + ") DESC"));
