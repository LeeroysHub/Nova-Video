...
public class VideoBadgePresenter extends Presenter {
    ...
    public class BadgeViewHolder extends ViewHolder {
        ...
        public void setResolution(int res,boolean is3d){
            ...
            switch (res){
                case (VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_4K):
                    mResImageView.setImageResource(R.drawable.badge_4k);
                    break;
                case (VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_1080P):
                    mResImageView.setImageResource(R.drawable.badge_1080);
                    break;
                case (VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_720P):
        ...
        public void setAudioBadge(int calculatedBestAudiotrack) {
            //mAudioImageView.setImageResource(calculatedBestAudiotrack == VideoStore.Video.VideoColumns.LEEROYFLIX_AUDIO_FIVEDOTONE ? R.drawable.badge_5_1 : R.drawable.badge_5_1);
        }
