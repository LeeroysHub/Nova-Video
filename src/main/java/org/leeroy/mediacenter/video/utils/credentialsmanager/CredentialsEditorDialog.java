...
public class CredentialsEditorDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View textEntryView = factory.inflate(org.leeroy.filecorelibrary.R.layout.samba_password_request, null);
        final EditText usernameET = (EditText) textEntryView.findViewById(org.leeroy.filecorelibrary.R.id.username_edit);
        usernameET.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
        final EditText passwordET = (EditText) textEntryView.findViewById(org.leeroy.filecorelibrary.R.id.password_edit);
        if (mCredential != null) {
