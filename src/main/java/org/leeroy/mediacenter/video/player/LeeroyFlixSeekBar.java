 ...
 */
public class LeeroyFlixSeekBar extends AppCompatSeekBar {
    ...
    public LeeroyFlixSeekBar(Context context) {
        super(context);
    }

    public LeeroyFlixSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LeeroyFlixSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
