...
public class BrightnessDialog extends AlertDialog implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    private LeeroyFlixSeekBar mSeekBar;
    ...
    private void init(Context context) {
        ...
        setView(view);
        mSeekBar = (LeeroyFlixSeekBar) view.findViewById(R.id.brightness_seekbar);
        mSeekBar.setOnEnableListener(new LeeroyFlixSeekBar.OnEnableListener() {
            @Override
