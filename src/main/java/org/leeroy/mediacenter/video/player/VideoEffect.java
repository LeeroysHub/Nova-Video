...
public class VideoEffect {
    ...
    public static final int EFFECT_STEREO_MERGE_LEEROYFLIX = 0x00020000;
    ...
    public static final boolean isStereoEffectOn(int type) {
        return ((type ==  EFFECT_STEREO_SPLIT) || (type ==  EFFECT_STEREO_MERGE_LEEROYFLIX) || (type ==  EFFECT_STEREO_MERGE) || isInForcedMode());
    }
