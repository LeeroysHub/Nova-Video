...
public class  UpdateRecommendationsService extends IntentService implements DefaultLifecycleObserver {
	...
	public static class Columns {
		...
		public static final String BOOKMARK = VideoStore.Video.VideoColumns.LEEROYFLIX_BOOKMARK;
		public static final String PATH = VideoStore.MediaColumns.DATA;
		public static final String RATING = "rating";
		public static final String COVER_PATH = "cover";
		public static final String DATE = "date";
		public static final String TRAKT_SEEN = VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN;

	}
	private static final int MAX_RECOMMENDATIONS = 3;
	private static final String SELECT_LAST_PLAYED = VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED
			+ "!=0";
	protected static final String HIDE_WATCHED_FILTER = " AND ("+VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN+" IS NULL OR "+VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN + " != "+Trakt.TRAKT_DB_MARKED
	...
	private static final String SORT_LAST_PLAYED = VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED
