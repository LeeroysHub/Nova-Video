...
public class Video extends Base implements Serializable {
    ...
    final int mVideo3dMode; // one of LEEROYFLIX_STEREO_2D, LEEROYFLIX_STEREO_3D_UNKNOWN, LEEROYFLIX_STEREO_3D_SBS, LEEROYFLIX_STEREO_3D_TB, LEEROYFLIX_STEREO_3D_ANAGLYPH
    final int mGuessedDefinition; // one of LEEROYFLIX_DEFINITION_UNKNOWN, LEEROYFLIX_DEFINITION_720P, LEEROYFLIX_DEFINITION_1080P
    ...
    public boolean is3D() {
        return (mVideo3dMode > VideoStore.Video.VideoColumns.LEEROYFLIX_STEREO_2D);
    }
    ...
    /**
     * @return the guessed definition according to the file name, i.e. one of LEEROYFLIX_DEFINITION_SD, LEEROYFLIX_DEFINITION_720P, LEEROYFLIX_DEFINITION_1080P
     */
    ...
    /**
     * turns calculated width and height DB or metadata information into one of LEEROYFLIX_DEFINITION_SD, LEEROYFLIX_DEFINITION_720P, LEEROYFLIX_DEFINITION_1080P
    ...
    public int getNormalizedDefinition(){
        ...
        if(w>0&&h>0) {
            ...
            if (w >= 3840 || h >= 2160) {
                return  VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_4K;
            }
            // normally you would expect w>=1920 || h>=1080 but based on collection empirical observation we need to include a margin to detect fhd video resolution
                ...
                return  VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_1080P;
            }
            // normally you would expect w>=1280 || h>=720 but based on collection empirical observation we need to include a margin to detect hd video resolution
                ...
                return  VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_720P;
            } else if (w > 0 && h > 0) {
                return  VideoStore.Video.VideoColumns.LEEROYFLIX_DEFINITION_SD;
            }
        }
