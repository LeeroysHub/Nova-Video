...
public class AllAnimesLoader extends VideoLoader {
    ...
    public String[] getProjection() {
        if(mGroupByOnlineId)
            return  concatTwoStringArrays(super.getProjection(),new String[]{ "max("+VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED+") as last",COUNT });
        else
    ...
    public String getSelection() {
        ...
        sb.append("( " + VideoStore.Video.VideoColumns.SCRAPER_S_GENRES + " LIKE '%" + mContext.getString(org.leeroy.medialib.R.string.tvshow_genre_animation) + "%' OR " +
