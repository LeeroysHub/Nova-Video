...
import org.leeroy.mediacenter.video.browser.loader.AllVideosLoader;
...
public class BrowserAllVideos extends CursorBrowserByVideo {
    ...
    private static final String SELECTION = VideoStore.Video.VideoColumns.LEEROYFLIX_HIDE_FILE + "=0";
