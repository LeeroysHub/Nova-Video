...
public class AnimesNShowsMapper implements CompatibleCursorMapper {
    ...
    public void bindColumns(Cursor c) {
        ...
        mScraperTypeColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_MEDIA_SCRAPER_TYPE);
        ...
        mLastTimePlayedColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_LAST_TIME_PLAYED);
        mResumeColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.BOOKMARK);
        mBookmarkColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_BOOKMARK);
        mSubsColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.SUBTITLE_COUNT_EXTERNAL);
        m3dColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_STEREO);
        mGuessedDefinitionColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_VIDEO_DEFINITION);
        mCalculatedBestAudiotrackColumn =c.getColumnIndex( VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_BEST_AUDIOTRACK_CHANNELS);
        mBestAudioFormatColumn =c.getColumnIndex( VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_BEST_AUDIOTRACK_FORMAT);
        mGuessedAudioFormatColumn =c.getColumnIndex( VideoStore.Video.VideoColumns.LEEROYFLIX_GUESSED_AUDIO_FORMAT);
        mGuessedVideoFormatColumn =c.getColumnIndex( VideoStore.Video.VideoColumns.LEEROYFLIX_GUESSED_VIDEO_FORMAT);
        mVideoFormatColumn =c.getColumnIndex( VideoStore.Video.VideoColumns.LEEROYFLIX_CALCULATED_VIDEO_FORMAT);
        ...
        // Trakt
        mTraktSeenColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN);
        mTraktLibraryColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_LIBRARY);
        // User can show/hide some files
        mUserHiddenColumn = c.getColumnIndex(VideoStore.Video.VideoColumns.LEEROYFLIX_HIDDEN_BY_USER);
