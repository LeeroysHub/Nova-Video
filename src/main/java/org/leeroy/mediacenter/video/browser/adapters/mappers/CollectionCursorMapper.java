...
public class CollectionCursorMapper implements CompatibleCursorMapper {
    ...
    public void bindColumns(Cursor cursor) {
        ...
        mTraktSeenColumn = cursor.getColumnIndexOrThrow( VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_SEEN);
        mTraktLibraryColumn = cursor.getColumnIndexOrThrow( VideoStore.Video.VideoColumns.LEEROYFLIX_TRAKT_LIBRARY);
