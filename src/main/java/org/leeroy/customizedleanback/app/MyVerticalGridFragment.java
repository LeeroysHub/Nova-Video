 ...
 * the License.
 */
package org.leeroy.customizedleanback.app;
...
public class MyVerticalGridFragment extends MyBrandedFragment {
    ...
    private String mEmptyMessage; // LEEROYFLIX ADDED
    private TextView mEmptyView; // LEEROYFLIX ADDED
    ...
    public void setGridPresenter(VerticalGridPresenter gridPresenter) {
        ...
        // LEEROYFLIX ADDED: update the number of columns in case the GridView is already created
    ...
    final private OnItemViewSelectedListener mViewSelectedListener =
            new OnItemViewSelectedListener() {
                ...
                public void onItemSelected(Presenter.ViewHolder itemViewHolder, Object item,
                    ...
                    // LEEROYFLIX ADDED: update the title in case the GridView is already created
                    if (mGridViewHolder != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mEmptyView = (TextView)root.findViewById(R.id.empty_view); // LEEROYFLIX ADDED
        if (mEmptyMessage!=null) { // LEEROYFLIX ADDED
            mEmptyView.setText(mEmptyMessage); // LEEROYFLIX ADDED
        } // LEEROYFLIX ADDED
