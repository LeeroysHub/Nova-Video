 ...
 * the License.
 */
package org.leeroy.customizedleanback.widget;
...
import org.leeroy.mediaplayer.video.leanback.widget.HintView;
...
public class MyTitleView extends RelativeLayout {
    ...
    private SearchOrbView mSearchOrbView2; // LEEROYFLIX added
    private SearchOrbView mSearchOrbView3; // LEEROYFLIX added
    private SearchOrbView mSearchOrbView4; // LEEROYFLIX added
    private SearchOrbView mSearchOrbView5; // LEEROYFLIX added

    private HintView mHintView; // LEEROYFLIX added
    private TextView mOrb1Description; // LEEROYFLIX added
    private TextView mOrb2Description; // LEEROYFLIX added
    private TextView mOrb3Description; // LEEROYFLIX added
    private TextView mOrb4Description; // LEEROYFLIX added
    private TextView mOrb5Description; // LEEROYFLIX added
    ...
    public MyTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSearchOrbView2 = (SearchOrbView) rootView.findViewById(R.id.title_orb2); // LEEROYFLIX added
        mSearchOrbView3 = (SearchOrbView) rootView.findViewById(R.id.title_orb3); // LEEROYFLIX added
        mSearchOrbView4 = (SearchOrbView) rootView.findViewById(R.id.title_orb4); // LEEROYFLIX added
        mSearchOrbView4.setVisibility(GONE);
        mSearchOrbView5 = (SearchOrbView) rootView.findViewById(R.id.title_orb5); // LEEROYFLIX added
        mSearchOrbView5.setVisibility(GONE);
        mHintView = (HintView) rootView.findViewById(R.id.hint_view); // LEEROYFLIX added

        mOrb1Description = (TextView) rootView.findViewById(R.id.orb1_description); // LEEROYFLIX added
        mOrb2Description = (TextView) rootView.findViewById(R.id.orb2_description); // LEEROYFLIX added
        mOrb3Description = (TextView) rootView.findViewById(R.id.orb3_description); // LEEROYFLIX added
        mOrb4Description = (TextView) rootView.findViewById(R.id.orb4_description); // LEEROYFLIX added
        mOrb5Description = (TextView) rootView.findViewById(R.id.orb5_description); // LEEROYFLIX added
